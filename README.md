...
Create a working directory for the workflow and clone the [main repository](https://github.com/charles-alchemcy/traffic-camera-object-detection) into your working directory.
...
```bash
git clone https://github.com/charles-alchemcy/traffic-camera-object-detection.git $WORKSPACE
```
...
issues](https://github.com/charles-alchemcy/traffic-camera-object-detection/issues).
